...
def main():
    ...
    for line in atomic_mass_file:
        ...
        if atom_and_mass.count(":") == 1:
            ...
            print(f'cannot split: {atom_and_mass}')
            continue
        ...
        if correct:
            ...
            print(f'cannot convert mass: {atom_and_mass}')
            continue
    ...
    #         vol_as_float_value = int(atom_and_vol_split[1])
    #         molecular_formula[atom_as_key] = vol_as_float_value
    #
    #     else:
    #         # print(atom_and_vol, "single")
    #         molecular_formula[atom_and_vol] = 1
    #
